...
export function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative container-px grid items-center gap-12 py-14 md:py-16 lg:grid-cols-[1.02fr_1fr] lg:gap-12 lg:py-20">
        {/* Copy */}
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-6 right-2 w-64 rounded-2xl border border-border/70 bg-background/95 p-3 shadow-2xl backdrop-blur-sm sm:right-4 sm:top-1/2 sm:-translate-y-1/2 lg:-right-4">
